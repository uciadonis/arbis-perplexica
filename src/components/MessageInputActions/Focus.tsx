...
const focusModes = [
  ...
  },
  {
    key: 'academicSearch',
    title: 'Academico',
    description: 'Buscar en publicaciones academicas',
    icon: <SwatchBook size={20} />,
  },
  {
    key: 'writingAssistant',
    title: 'Escritura',
    description: 'Chatea sin buscar en la web',
    icon: <Pencil size={16} />,
  },
  {
  ...
  },
  {
    key: 'youtubeSearch',
    title: 'Youtube',
    description: 'Buscar videos y tutoriales',
    icon: <SiYoutube className="h-5 w-auto mr-0.5" />,
  },
  {
    key: 'redditSearch',
    title: 'Reddit',
    description: 'Busca discusiones y opiniones',
